<div class="ssk-sticky ssk-left ssk-center ssk-lg ssk-group ssk-count">
    <a href="{{url()->current()}}" data-text="Text for facebook" class="ssk ssk-facebook"></a>
    <a href="{{url()->current()}}" class="ssk ssk-twitter"></a>
    <a href="{{url()->current()}}" class="ssk ssk-google-plus"></a>
